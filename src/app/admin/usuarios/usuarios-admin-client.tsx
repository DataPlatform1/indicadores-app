    ...
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,#dff4ff_0%,#f7fbff_45%,#eef4e8_100%)] px-4 py-8 text-slate-900">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-6">
        <AdminNavigation
          ...
          description="Administra accesos, roles y estado de cuentas desde un panel mas claro y conectado con el resto del sistema."
        />
                  ...
                  <tbody>
                    {users.map((user) => (
                      <Fragment key={user.id}>
                        <tr className="rounded-2xl bg-slate-50 text-sm text-slate-700 shadow-[0_8px_24px_rgba(15,23,42,0.06)]">
