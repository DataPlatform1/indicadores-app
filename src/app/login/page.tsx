...
export default function LoginPage() {
  ...
  return (
    <main className="brand-page grid min-h-screen place-items-center px-4 py-8">
      <section className="brand-panel w-full max-w-md rounded-[2rem] p-8">
        <div className="flex flex-col items-center text-center">
          {branding.assets.logoImageUrl ? (
            <img
              alt={`${branding.organizationName} logo`}
              className="h-16 w-16 rounded-full object-cover shadow-[0_16px_32px_rgba(15,23,42,0.18)]"
